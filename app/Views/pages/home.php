          ...
          <div class="container py-5">
            <div class="row align-items-center min-vh-50">
              ...
              <div class="col-lg-6 mt-4 mt-lg-0">
                <img src="<?php echo base_url('public/assets/img/RTX-4090.jpg') ?>" alt="Tarjeta Gráfica NVIDIA RTX 4090" class="img-fluid shadow-sm rounded" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="hero-slide d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%)">
          <div class="container py-5">
            <div class="row align-items-center min-vh-50">
              ...
              <div class="col-lg-6 mt-4 mt-lg-0">
                <img src="<?php echo base_url('public/assets/img/ryzen.jpg') ?>" alt="Procesador AMD Ryzen 9" class="img-fluid shadow-sm rounded" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="hero-slide d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)">
          <div class="container py-5">
            <div class="row align-items-center min-vh-50">
              ...
              <div class="col-lg-6 mt-4 mt-lg-0">
                <img src="https://picsum.photos/id/280/1200/800" alt="Unidad SSD NVMe de alta velocidad" class="img-fluid shadow-sm rounded" />
              </div>
            </div>
          </div>
        </div>
