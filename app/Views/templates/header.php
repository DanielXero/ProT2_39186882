      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          ...
          >
            ...
            <form class="search-form w-100 position-relative">
              <i class="bi bi-search search-icon"></i>
              <input
                class="form-control ps-2 py-2"
                type="search"
              ...
              />
              <div
                class="autocomplete-results position-absolute w-100 mt-1 bg-white border shadow-sm rounded-1 d-none"
            ...
            <!-- Grupo derecho -->
            <ul class="navbar-nav mb-2 mt-4 mt-lg-0">
              <li class="nav-item">
                <a class="btn btn-outline-primary" href="<?= site_url('/login') ?>"
                  >Ingresar</a
                >
              </li>
            </ul>
